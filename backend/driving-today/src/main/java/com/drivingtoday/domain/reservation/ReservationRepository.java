...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("SELECT r FROM Reservation r " +
            "JOIN FETCH r.instructor i JOIN FETCH i.academy a " +
            "WHERE r.isAccepted = true AND (r.reservationDate > :currentDate " +
    ...
    @Query("SELECT COUNT(r) FROM Reservation r " +
            "WHERE r.isAccepted = true AND r.instructor.id = :instructorId AND r.reservationDate = :date " +
