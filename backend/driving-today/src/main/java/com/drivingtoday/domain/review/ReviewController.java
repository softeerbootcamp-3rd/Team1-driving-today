...
public class ReviewController {
    ...
    @GetMapping("/reviews")
    public ResponseEntity<SliceResponse<Review>> reviewList(@RequestParam("instructorId") Long instructorId,
                                                            @RequestParam("pageNumber") Integer pageNumber,
                                                            @RequestParam("pageSize") Integer pageSize) {
        SliceResponse<Review> reviews = reviewFindService.findReviews(instructorId, pageNumber, pageSize);
